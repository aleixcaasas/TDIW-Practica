    ...
    <div class="universeregister" style="grid-area: registerGrid;">
        <form action="" method="post">
            <section class="register">
                ...
                <input class="controls" type="text" placeholder="Apellidos" name="cognom"
                       pattern="([a-zA-Z]+\s){0,}([a-zA-Z]+)" required>

                <label for="email"><b>Correo electrónico</b></label>
                <input class="controls" type="mail" name="email" placeholder="Correo Electronico"
                ...
                <input class="controls" type="text" placeholder="Población" name="ciutat" maxlength="30"
                       pattern="([a-zA-Z]+\s){0,}([a-zA-Z]+)" required>

                <label for="postal"><b>Código Postal</b></label>
                <input class="controls" type="text" id="postal" placeholder="Codigo Postal" name="postal" maxlength="5"
                       pattern="[0-9]{4,}([0-9]+)" required>
