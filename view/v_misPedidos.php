            ...
            <table id="taulaPedidos">
                ...
                <?php foreach ($retorn['productes_comanda'][$comanda['id']] as $product): ?>
                    <tr>
                        ...
                        <td> <?php echo($product[unitats] * $retorn['info_productes'][$product['id_producte']][0][preu]) ?>
                            ,00 €
                        </td>
                    </tr>
                <?php endforeach; ?>
                <tr>
                    <td id="msgCarrito" colspan='4'> El importe total es : <?php echo $comanda['import_total'] ?>  </td>
                </tr>
            </table>
        <?php endforeach; ?>
    <?php } else { ?>
