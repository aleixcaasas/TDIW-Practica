...
<div id="capçalera">
    <header style="grid-area: info_superior">
        <p>Pàgina web creada per Aleix Casas Barco (1604174) i Èric Subirana Garcia (1603465) - Tecnologies de
            Desenvolupament d'Internet i Web 2022-23</p>
    </header>
    <div class="menu">
        ...
        <section class="menu_user" style="grid-area: menu_user">
            ...
            <button id="botoCarrito" onclick="popUpCart()"><img src="../img/icons/shopping_icon.png"
                                                                id="button-hide-elements2" height="50" width="auto">
            </button>
